...
**총 테스트 케이스: 187** (인프로세스 164개 + envtest 통합 20개 + 클러스터 레벨 3개; E18 Agent 다운 시나리오 7개 · E21 잘못된 CR 시나리오 26개 · E3.16–E3.20 스테이징 단계 심화 18개 포함 / 수동 AD 시나리오 3개 별도)
...
> 빌드 태그 없음 | `go test ./test/e2e/ -v` | 총 152개 테스트 (E3.16–E3.20 스테이징 심화 18개 포함)
...
| E3 | CSI Node — Stage / Publish / Unstage / Unpublish (E3.1–E3.20) | 52 | `TestCSINode_*`, `TestNodeStageVolume_*`, `TestNodeUnstageVolume_*`, `TestStageState_*` |
