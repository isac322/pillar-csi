...
**총 테스트 케이스: 217** (인프로세스 194개 + envtest 통합 20개 + 클러스터 레벨 3개; E18 Agent 다운 시나리오 7개 · E21 잘못된 CR 시나리오 26개 · E22 비호환 프로토콜 시나리오 12개 · E3.16–E3.20 스테이징 단계 심화 18개 · E3.21–E3.23 게시 단계 단위 테스트 18개 포함 / 수동 AD 시나리오 3개 · BP 시나리오 4개 별도)
...
- [E26: PillarProtocol CRD 라이프사이클](#e26-pillarprotocol-crd-라이프사이클)
- [E27: PillarBinding CRD 라이프사이클](#e27-pillarbinding-crd-라이프사이클)
