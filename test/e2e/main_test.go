...
// budget: 404 default-profile specs × ~0.1ms each = ~40ms at 1 worker, so 8
...
// the 404 "default-profile" specs execute.  Long-running tests (e.g. the
...
// is not set. It restricts the default parallel run to the 404 "default-profile"
