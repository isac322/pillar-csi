...
var inProcessAssertions = map[string]func(documentedCase){
	...
	"TestCSIEdge_ControllerPublish_EmptyNodeId":      assertE14_ControllerPublish_EmptyNodeId,
	"TestCSIEdge_CreateVolume_LimitLessThanRequired": assertE14_CreateVolume_LimitLessThanRequired,
	"TestCSIEdge_CreateVolume_MultiNodeMultiWriter":  assertE14_CreateVolume_MultiNodeMultiWriter,
	...
	"TestCSIExhaustion_ExpandVolume_ExceedsPoolCapacity": assertE15_ExpandVolume_ExceedsPoolCapacity,
	...
	"TestCSIConcurrent_NodeStage_SameVolumeDifferentPaths": assertE16_NodeStage_SameVolumeDifferentPaths,
	...
	"TestCSICleanup_NodeStage_MountFailureDisconnects":     assertE17_NodeStage_MountFailureDisconnects,
	"TestCSICleanup_NodeUnstage_FailurePreservesStateFile": assertE17_NodeUnstage_FailurePreservesStateFile,
	"TestCSICleanup_CreatePartial_DeleteVolumeCleansCRD":   assertE17_CreatePartial_DeleteVolumeCleansCRD,
	"TestCSICleanup_FullLifecycle_NoResourceLeak":          assertE17_FullLifecycle_NoResourceLeak,
	"TestCSICleanup_RepeatedStageUnstage":                  assertE17_RepeatedStageUnstage,
	...
	"TestCSIInvalidCR_CreateVolume_TargetSpecBothNil": assertE21_CreateVolume_TargetSpecBothNil,
	"TestCSIInvalidCR_LoadState_UnknownPhase":         assertE21_LoadState_UnknownPhase,
	"TestCSIInvalidCR_LoadState_ListFailure":          assertE21_LoadState_ListFailure,
	...
	"TestCSIProtocol_CreateVolume_ISCSIUnimplemented":                   assertE22_CreateVolume_ISCSIUnimplemented,
	"TestCSIProtocol_CreateVolume_UnknownProtocol_MapsToUnspecified":    assertE22_CreateVolume_UnknownProtocol_MapsToUnspecified,
	...
	"TestAgent_LVM_RoundTrip_Thin":                            assertE28_LVM_RoundTrip_Thin,
	"TestAgent_LVM_GetCapacity_LinearVG":                      assertE28_LVM_GetCapacity_LinearVG,
	"TestAgent_LVM_GetCapacity_ThinPool":                      assertE28_LVM_GetCapacity_ThinPool,
	"TestAgent_LVM_GetCapacity_ThinPoolOverProvisioned":       assertE28_LVM_GetCapacity_ThinPoolOverProvisioned,
	"TestAgent_LVM_GetCapacity_FullVG":                        assertE28_LVM_GetCapacity_FullVG,
	"TestAgent_LVM_ListVolumes_SkipsThinPoolLV":               assertE28_LVM_ListVolumes_SkipsThinPoolLV,
	"TestAgent_LVM_ListVolumes_Linear_AllReturned":            assertE28_LVM_ListVolumes_Linear_AllReturned,
	"TestAgent_LVM_CreateVolume_LinearModeParam":              assertE28_LVM_CreateVolume_LinearModeParam,
	"TestAgent_LVM_CreateVolume_ThinModeParam":                assertE28_LVM_CreateVolume_ThinModeParam,
	"TestAgent_LVM_CreateVolume_EmptyMode_DefaultsToBackend":  assertE28_LVM_CreateVolume_EmptyMode_DefaultsToBackend,
	"TestAgent_LVM_CreateVolume_VGNotFound":                   assertE28_LVM_CreateVolume_VGNotFound,
	"TestAgent_LVM_ExpandVolume_ShrinkRejected":               assertE28_LVM_ExpandVolume_ShrinkRejected,
	"TestAgent_LVM_CreateVolume_ThinWithoutPool":              assertE28_LVM_CreateVolume_ThinWithoutPool,
	"TestAgent_LVM_CreateVolume_Idempotent":                   assertE28_LVM_CreateVolume_Idempotent,
	"TestAgent_LVM_DeleteVolume_NonExistent_Idempotent":       assertE28_LVM_DeleteVolume_NonExistent_Idempotent,
	"TestAgent_LVM_ReconcileState_RestoresExports":            assertE28_LVM_ReconcileState_RestoresExports,
	"TestAgent_LVM_CreateVolume_ReservedPrefix_Snapshot":      assertE28_LVM_CreateVolume_ReservedPrefix_Snapshot,
	"TestAgent_LVM_CreateVolume_ReservedPrefix_Pvmove":        assertE28_LVM_CreateVolume_ReservedPrefix_Pvmove,
	"TestAgent_LVM_CreateVolume_InvalidFirstChar_Hyphen":      assertE28_LVM_CreateVolume_InvalidFirstChar_Hyphen,
	"TestAgent_LVM_CreateVolume_MaxLength_128":                assertE28_LVM_CreateVolume_MaxLength_64,
	"TestAgent_LVM_CreateVolume_OverMaxLength_129":            assertE28_LVM_CreateVolume_OverMaxLength_65,
	"TestAgent_LVM_CreateVolume_ExtraFlags_Forwarded":         assertE28_LVM_CreateVolume_ExtraFlags_Forwarded,
	"TestAgent_LVM_CreateVolume_ExtraFlags_Empty_NoEffect":    assertE28_LVM_CreateVolume_ExtraFlags_Empty_NoEffect,
	"TestAgent_LVM_CreateVolume_VGOverride_Mismatch_Rejected": assertE28_LVM_CreateVolume_VGOverride_Mismatch_Rejected,
	"TestAgent_LVM_CreateVolume_ThinPool_NearFull":            assertE28_LVM_CreateVolume_ThinPool_NearFull,
	...
	"TestCSIController_LVM_ModeOverride_EmptyPVCAnnotation_FallsThrough": assertE29_LVM_ModeOverride_EmptyPVCAnnotation_FallsThrough,
	"TestCSIController_DeleteVolume_LVM":                                 assertE29_DeleteVolume_LVM,
